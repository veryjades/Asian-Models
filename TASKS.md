...
| UX-004 | Deploy the resulting branch to an isolated Preview and complete desktop/mobile experience review.                        | Codex | In progress | UX-002, UX-003        | Build and lint pass; deploy the committed branch, then validate hero framing, arrows, swipe, CTA targets, board cards, and profile galleries.                                                            |
