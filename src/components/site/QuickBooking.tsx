...
export function QuickBooking({ className = "", modelId, modelName }: QuickBookingProps) {
  ...
  return (
    ...
    >
      ...
      <DialogContent className="bottom-0 top-auto max-h-[88vh] translate-y-0 overflow-hidden p-0 sm:bottom-auto sm:top-[50%] sm:max-w-2xl sm:translate-y-[-50%]">
        ...
        <div className="max-h-[calc(88vh-0.25rem)] overflow-y-auto">
          <DialogHeader className="border-b border-border px-5 py-5 text-left">
            <DialogTitle className="text-xl font-light leading-tight">{title}</DialogTitle>
            <DialogDescription className="mt-2 text-xs">{t("booking.intro")}</DialogDescription>
          </DialogHeader>
