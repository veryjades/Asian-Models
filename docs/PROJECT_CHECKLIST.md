...
- [~] Reconcile PR #4/#5 before review. PR #5 metadata now describes its actual stacked scope; PR #6 and PR #7 CI are merged. Do not retarget PR #5 to `main` until PR #4 is reviewed and merged.
