...
4. `docs/STATUS.md` — the latest heartbeat and concise operational status.
5. Any phase-specific documents under `docs/architecture/` that the files above reference.
...
- Update `docs/STATUS.md` at the end of each active work session and whenever a task or blocker changes; it is a summary and must not override the other control records.
